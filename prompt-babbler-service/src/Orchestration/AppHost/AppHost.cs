...
// Azure AI Foundry resource — Aspire auto-provisions in your Azure subscription.
// Azure:SubscriptionId, Azure:TenantId are REQUIRED — set via dotnet user-secrets (see QUICKSTART.md).
